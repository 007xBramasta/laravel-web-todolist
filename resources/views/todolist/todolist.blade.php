    ...
    <div class="container col-xl-10 col-xxl-8 px-4 py-5">
        ...
        <div class="row align-items-center g-lg-5 py-5">
            <div class="col-lg-7 text-center text-lg-start">
                ...
                <p class="col-lg-10 fs-4">by <a target="_blank" href="https://www.instagram.com/007xbramasta/">Bramasta
                        Albatio Haryono
                    </a></p>
            </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Edit Form -->
                                <form action="/todolist/{{ $todolist[$i]['id'] }}/edit" method="post">
                                    @csrf
                                    <input type="text" class="form-control" name="newTodo" value="{{ $todolist[$i]['todo'] }}"
                                        style="display: inline-block; width: 60%;" required>
                                    <button class="btn btn-sm btn-warning" type="submit">Edit</button>
                                </form>
                            </td>
                            <td>
                                <!-- Remove Form -->
                                <form action="/todolist/{{ $todolist[$i]['id'] }}/delete" method="post">
                                    @csrf
